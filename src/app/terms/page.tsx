...
const sections = [
  {
    title: '제1조 (서비스 성격)',
    body: '꼬북점은 사주, 운세, 궁합, 인연 분석과 — 회원이 선택적으로 이용하는 — 이용자 간 인연 매칭 기능을 엔터테인먼트와 자기이해 목적으로 제공하는 서비스입니다. 모든 결과와 매칭은 참고용이며, 전문 의료, 법률, 금융, 심리 상담이나 중매·결혼중개를 대체하지 않습니다.',
  },
  {
    title: '제2조 (회원 정보 관리)',
  ...
  {
    title: '제7조 (이용자 행동 규범 및 금지 행위)',
    body: '회원은 다음 행위를 하여서는 안 됩니다: ① 서비스 악용·자동화된 과도한 호출·결과물의 무단 대량 복제·운영 방해, ② 타인의 개인정보 무단 입력·수집·이용, ③ 매칭에서 상대에 대한 성희롱·욕설·협박·차별·스토킹·명예훼손, ④ 금전·투자·종교·다단계 권유 등 상업적·기망적 목적의 접근, ⑤ 타인 사칭 또는 허위 프로필 작성, ⑥ 미성년자를 대상으로 한 부적절한 접근, ⑦ 음란물·불법정보의 전송, ⑧ 상대의 연락처·금융정보·신체정보 등 민감정보를 부당하게 요구하는 행위.',
  },
  {
    title: '제8조 (신고·차단·이용 제한)',
    body: '회사는 회원의 신고 또는 모니터링을 통해 본 약관 또는 법령 위반이 확인되거나 합리적으로 의심되는 경우, 사전 통지 없이 해당 콘텐츠 삭제, 매칭 기능 일부 또는 전부의 제한, 계정 일시 정지 또는 영구 이용 정지 등의 조치를 취할 수 있습니다. 긴급한 위해가 우려되는 경우 즉시 조치 후 사후 통지할 수 있습니다.',
  },
  {
    title: '제9조 (미성년자 보호)',
    body: '만 14세 미만은 회원으로 가입할 수 없습니다. 인연 매칭 기능은 안전을 위해 만 19세 이상 회원에게 제공하는 것을 원칙으로 하며, 회사는 청소년 보호를 위해 매칭 대상·노출 범위를 제한할 수 있습니다. 회원은 가입 및 매칭 이용 시 본인의 연령 정보가 정확함을 보증합니다.',
  },
  {
    title: '제10조 (책임의 한계)',
    body: '꼬북점이 제공하는 운세·궁합·풀이는 참고용 정보이며, 이를 근거로 한 사용자의 의사결정과 그 결과에 대해 회사는 법령이 허용하는 범위에서 책임을 지지 않습니다. 또한 회사는 회원 간 매칭 과정에서 발생하는 회원 상호 간의 분쟁, 상대 회원이 제공한 정보의 진실성, 회원 간의 거래나 오프라인 만남 및 그로 인한 손해에 대하여 고의 또는 중대한 과실이 없는 한 책임을 지지 않습니다. 회원은 낯선 상대와의 소통 및 만남에 스스로 주의를 기울여야 합니다.',
  },
  {
    title: '제11조 (약관 변경)',
    body: '서비스 운영상 필요한 경우 약관이 변경될 수 있으며, 중요한 변경은 시행 7일 전(이용자에게 불리한 변경은 30일 전) 앱 또는 웹사이트를 통해 안내합니다. 매칭 등 신규 기능이 실제로 출시되는 시점에는 해당 기능에 대한 별도 동의를 받습니다.',
  },
];
  ...
  return (
    <main className="mx-auto flex min-h-dvh w-full max-w-2xl flex-col gap-6 px-6 py-12 text-ink">
      <header className="space-y-3">
        ...
        <p className="text-sm font-bold text-muted">시행일: 2026년 7월 21일</p>
      </header>
