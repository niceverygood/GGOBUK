...
## 구조 (마크다운 헤딩 없이)
- 총 3 단락, 각 단락 정확히 4-6문장. 그 이상 늘리지 마라.
...
## 분량 통제 — 매우 중요
- 전체 분량은 600-900자 안팎. 절대 1200자를 넘기지 마라.
- 토큰이 부족하지 않게 미리 가늠해 쓰고, 어떤 경우에도 문장을 마침표로 마무리해야 한다. 중간에 잘리면 안 된다.
- 4번째, 5번째 단락을 만들지 마라. 더 쓰고 싶어도 3단락에서 끝낸다.
